...
<body class="db-body">
    ...
    $firstName = session()->get('first_name') ?? session()->get('username') ?? 'Secretary';
    $today     = date('l, F d, Y');
    ...
    <div class="db-main">
        ...
        <div class="db-content">
            ...
            <div class="dash-welcome">
                ...
                <div class="dash-welcome-icon"><i class="fas fa-user-edit"></i></div>
            </div>

            <!-- Stats row -->
            <div class="dash-grid">
                <a href="/secretary/census" class="dash-stat">
                ...
                <a href="/secretary/clearance" class="dash-stat">
                ...
                <a href="/secretary/pending-accounts" class="dash-stat">
                ...
                <div style="display:flex;flex-direction:column;gap:20px;">
                    ...
                    <div class="dash-card">
                        <div class="dash-card-head">
                            ...
                            <a href="/secretary/clearance">View all →</a>
                        </div>
                    ...
                    <div class="dash-card">
                        <div class="dash-card-head">
                            ...
                            <a href="/secretary/blotter">View all →</a>
                        </div>
                ...
                <div style="display:flex;flex-direction:column;gap:20px;">
                    ...
                    <div class="dash-card">
                        <div class="dash-card-head">
                            ...
                            <a href="/secretary/calendar">Calendar →</a>
                        </div>
                        <?php
                    ...
                    <div class="dash-card">
                        <div class="dash-card-head">
                            ...
                            <a href="/secretary/reports">Reports →</a>
                        </div>
                    ...
                    <div class="dash-card">
                        ...
                        <div class="dash-links">
                            <a href="/secretary/census" class="dash-link"><i class="fas fa-home"></i> Census</a>
                            <a href="/secretary/clearance" class="dash-link"><i class="fas fa-file-alt"></i> Clearances</a>
                            <a href="/secretary/blotter" class="dash-link"><i class="fas fa-gavel"></i> Blotter</a>
                            <a href="/secretary/calendar" class="dash-link"><i class="fas fa-calendar"></i> Calendar</a>
                            <a href="/secretary/pending-accounts" class="dash-link"><i class="fas fa-user-check"></i> Approvals</a>
                            <a href="/secretary/create-account" class="dash-link"><i class="fas fa-user-plus"></i> Create Account</a>
                        </div>
                    </div>
